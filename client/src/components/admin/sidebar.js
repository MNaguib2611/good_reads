    ...
    return (
        <div className="layout_container">
            <div className="side nav-container">
                <div className="card">
                    <ul>
                        <li className="nav-list" onClick={() => changeOption(1)} style={{backgroundColor: selectedOption == 1 && '#F56D3A'}}><FontAwesomeIcon icon={faThLarge} size="lg"/><span>Categories</span></li>
